...
[create_tables.sql](https://raw.githubusercontent.com/hellojohncruz/movie_surveys/main/create_tables.sql)
  ...
  - The SQL code is created based off this [ER Diagram](https://raw.githubusercontent.com/hellojohncruz/movie_surveys/main/er_diagram.png). 
...
avg_rating <- df %>% filter(!is.na(rating)) %>% 
  ...
  summarize(avg_rating = mean(rating), count = n(), .groups = 'drop') %>%
